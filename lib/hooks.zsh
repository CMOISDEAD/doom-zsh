...
# start and scan dir with gitstatus.plugin
doom_git_scan_dir() {
    # scan the actual dir and set the variables with respective git information
...
prompt_doom_precmd() {
    ...
    doom_exec_time_stop
    # Scan the current dir before every command (and after ?)
    doom_git_scan_dir
}
